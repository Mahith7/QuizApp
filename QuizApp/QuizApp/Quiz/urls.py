...
urlpatterns = [
    ...
    path('teachers/', include(([
        ...
        path('quiz/<int:pk>/delete/', views.QuizDeleteView.as_view(), name='quiz_delete'), # yet to test shared quiz delete operation
        ...
        path('quiz/<int:pk>/share/', views.share_with_teacher, name='quiz_share'),
